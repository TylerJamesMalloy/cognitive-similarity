...
random_sample = decisions["UserId"].unique()[200]
...
g.figure.suptitle("Individual Participant and Semantic Cosine Similarity \n of Phishing and Ham Emails (Participant 1)", fontsize=18)
