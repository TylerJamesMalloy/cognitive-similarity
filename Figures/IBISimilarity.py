...
decisions = pd.read_pickle("../Database/Responses.pkl")
"""
Index(['MturkId', 'UserId', 'Experiment', 'EmailId', 'PhaseTrial', 'DataType',
       'Decision', 'MessageNum', 'Message', 'EmailType', 'PhaseValue',
       'ExperimentCondition', 'Confidence', 'EmailAction', 'ReactionTime',
       'Correct', 'Age', 'Gender', 'Education', 'Country', 'Victim', 'Chatbot',
       'Consent', 'Q0', 'Q1', 'Q2', 'Q3', 'Q4', 'Q5', 'PQ0', 'PQ1', 'PQ2',
       'PQ3', 'PQ4', 'PQ5', 'Rejected', 'ExperimentTrial'],
"""
...
random_sample = decisions["MturkId"].unique()[150]
...
for author in emails['Author'].unique():
    for style in emails['Style'].unique():
        ...
        for cIdx, cEmail in memails.iterrows():
            ...
            dec = decisions[decisions["MturkId"] == random_sample]
