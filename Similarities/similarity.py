...
p = sns.jointplot(data=qdf, x="Ham Similarity", y="Phishing Similarity", palette=combined_palette, hue="Type", xlim = (-0.1,1.1), ylim = (-0.1,1.1)).plot_joint(sns.kdeplot, zorder=0, n_levels=10)
p.fig.suptitle("Human Participant and Cosine Similarity \n of Phishing and Ham Emails")
p.ax_joint.collections[0].set_alpha(0.5)
p.fig.tight_layout()
p.fig.subplots_adjust(top=0.95) # Reduce plot to make room
